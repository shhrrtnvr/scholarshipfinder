...
{
    public partial class ReferScholarshipAlumni : Form
    {
        public ReferScholarshipAlumni()
        {
            InitializeComponent();
        }

        private void ReferScholarship_Load(object sender, EventArgs e)
        {
            label6.Text = DashboardAlumni.Username;
